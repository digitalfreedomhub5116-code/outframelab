...
const RAW_PRODUCTS = [
  // ── MARVEL ── (Iron Man & Spider-Man set to 249)
  { id: 1,  name: 'Iron Man',         genre: 'MARVEL',   price: 249, originalPrice: 459, reviewCount: 11, rating: 4.7, badCount: 2 },
  { id: 2,  name: 'Spider-Man',       genre: 'MARVEL',   price: 249, originalPrice: 459, reviewCount: 13, rating: 4.8, badCount: 2 },
  { id: 3,  name: 'Thor',             genre: 'MARVEL',   price: 189, originalPrice: 459, reviewCount: 9,  rating: 4.6, badCount: 2 },
  { id: 4,  name: 'Hulk',             genre: 'MARVEL',   price: 189, originalPrice: 459, reviewCount: 7,  rating: 4.7, badCount: 1 },
  { id: 5,  name: 'Captain America',  genre: 'MARVEL',   price: 189, originalPrice: 459, reviewCount: 15, rating: 4.8, badCount: 2 },

  // ── DC ── (Batman set to 249)
  { id: 6,  name: 'Batman',           genre: 'DC',       price: 249, originalPrice: 459, reviewCount: 13, rating: 4.9, badCount: 2 },
  { id: 7,  name: 'Superman',         genre: 'DC',       price: 189, originalPrice: 459, reviewCount: 9,  rating: 4.8, badCount: 1 },

  // ── CARS ── (Porsche set to 249)
  { id: 8,  name: 'Porsche',          genre: 'CARS',     price: 249, originalPrice: 459, reviewCount: 15, rating: 4.9, badCount: 2 },
  { id: 9,  name: 'Mustang',          genre: 'CARS',     price: 189, originalPrice: 459, reviewCount: 11, rating: 4.7, badCount: 2 },
  { id: 10, name: 'BMW',              genre: 'CARS',     price: 189, originalPrice: 459, reviewCount: 13, rating: 4.8, badCount: 2 },
  { id: 11, name: 'Ferrari',          genre: 'CARS',     price: 189, originalPrice: 459, reviewCount: 9,  rating: 4.8, badCount: 1 },

  // ── VALORANT ── (Jett set to 249)
  { id: 12, name: 'Jett',             genre: 'VALORANT', price: 249, originalPrice: 459, reviewCount: 15, rating: 4.9, badCount: 2 },
  { id: 13, name: 'Reyna',            genre: 'VALORANT', price: 189, originalPrice: 459, reviewCount: 11, rating: 4.7, badCount: 2 },
  { id: 14, name: 'Sage',             genre: 'VALORANT', price: 189, originalPrice: 459, reviewCount: 7,  rating: 4.8, badCount: 1 },
  { id: 15, name: 'Chamber',          genre: 'VALORANT', price: 189, originalPrice: 459, reviewCount: 9,  rating: 4.8, badCount: 1 },
  { id: 16, name: 'Clove',            genre: 'VALORANT', price: 189, originalPrice: 459, reviewCount: 7,  rating: 4.6, badCount: 1 },

  // ── ANIME ── (Naruto & Luffy set to 249)
  { id: 17, name: 'Naruto',           genre: 'ANIME',    price: 249, originalPrice: 459, reviewCount: 15, rating: 4.9, badCount: 1 },
  { id: 18, name: 'Luffy',            genre: 'ANIME',    price: 249, originalPrice: 459, reviewCount: 13, rating: 4.8, badCount: 2 },
  { id: 19, name: 'Ichigo',           genre: 'ANIME',    price: 189, originalPrice: 459, reviewCount: 9,  rating: 4.6, badCount: 2 },
  { id: 20, name: 'Goku',             genre: 'ANIME',    price: 189, originalPrice: 459, reviewCount: 15, rating: 4.9, badCount: 2 },
  { id: 21, name: 'Aizen',            genre: 'ANIME',    price: 189, originalPrice: 459, reviewCount: 11, rating: 4.8, badCount: 2 },
  { id: 22, name: 'Madara',           genre: 'ANIME',    price: 189, originalPrice: 459, reviewCount: 13, rating: 4.9, badCount: 2 },
  { id: 23, name: 'Doflamingo',       genre: 'ANIME',    price: 189, originalPrice: 459, reviewCount: 7,  rating: 4.7, badCount: 1 },
  { id: 24, name: 'Gojo',             genre: 'ANIME',    price: 189, originalPrice: 459, reviewCount: 15, rating: 5.0, badCount: 1 },
...
export const MOCK_PRODUCTS = RAW_PRODUCTS.map((p) => {
  ...
  const originalPrice = p.originalPrice || 459
  const discountPercent = p.price === 189 ? 58 : Math.round(((originalPrice - p.price) / originalPrice) * 100)
